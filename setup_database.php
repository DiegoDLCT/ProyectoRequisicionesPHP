...
try {
    ...
    if ($exists) {
        echo "   Base de datos ya existe. Recreando...\n";
    ...
    $migrationFile = dirname(__FILE__) . '/migrations/setup_complete.sql';
    ...
    // Reconectar a la BD para asegurar que los cambios se aplicaron
    $conn = new PDO("mysql:host=$dbHost;dbname=$dbName", $dbUser, $dbPassword);
    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
