    ...
    public function crear() {
        ...
        $query = "INSERT INTO " . $this->table_name . " 
                  SET cFolio=:folio, dFechaSolicitud=:fecha_solicitud, 
                      ...
                      cMaquina=:maquina, cObraUbicacion=:obra_ubicacion, 
                      estado=:estado, lActivo=:activo";
        ...
        $this->cObraUbicacion = $this->cObraUbicacion ? htmlspecialchars(strip_tags($this->cObraUbicacion)) : null;
        ...
        $stmt->bindParam(":activo", $this->lActivo);
