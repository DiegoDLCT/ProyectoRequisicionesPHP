...
<body>
                        ...
                        <?php foreach ($requisiciones as $req): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning" onclick="abrirModalConfirmacion(<?= $req['id'] ?>, '<?= htmlspecialchars($req['cFolio']) ?>')">
    ...
    <div class="modal-overlay" id="modalConfirmacion">
        <div class="modal">
            <h2><i class="bi bi-box-seam"></i> Marcar Para Entregar</h2>
            <p>¿Deseas marcar la requisición <strong id="folioReq"></strong> como lista para entregar?</p>
            <div class="modal-actions">
                <button type="button" class="btn btn-cancel" onclick="cerrarModal()">Cancelar</button>
                <button type="button" class="btn btn-warning" onclick="confirmarEntrega()">Confirmar</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function confirmarEntrega() {
            ...
            fetch('/ProyectoPHP/frontend/services/marcar_por_entregar_ajax.php', {
                method: 'POST',
                body: formData
            })
            .then(response => {
