...
$requisiciones = $pagoController->obtenerPorEstadoConCotizacion('solicitar_pago');
...
<body>
    <div class="container">
        <div class="header">
            <h1>Solicitar Pagos</h1>
            <p>Requisiciones aprobadas pendientes de solicitud de pago</p>
        </div>
        ...
        <div class="table-container">
            <?php if (empty($requisiciones)): ?>
                <div class="empty">
                    ...
                    <p>No hay requisiciones pendientes de solicitar pago</p>
                </div>
            <?php else: ?>
                <table>
                    <thead>
                        ...
                        <?php foreach ($requisiciones as $req): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <form method="POST" action="/ProyectoPHP/backend/services/solicitar_pago_service.php" style="display: inline;">
