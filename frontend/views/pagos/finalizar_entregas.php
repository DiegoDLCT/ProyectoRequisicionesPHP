...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Confirma la entrega de las cotizaciones al solicitante</p>
        </div>
                        ...
                        <?php foreach ($requisiciones as $req): ?>
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <form method="POST" action="/ProyectoPHP/backend/services/marcar_entregado_service.php" style="display: inline;">
                                        <input type="hidden" name="id_requisicion" value="<?= $req['id'] ?>">
                                        <button type="submit" class="btn btn-sm btn-success" onclick="return confirm('¿Confirmar que se ha entregado al solicitante?')">
