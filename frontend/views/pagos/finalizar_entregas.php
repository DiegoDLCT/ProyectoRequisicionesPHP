...
// Obtener requisiciones en estado por_entregar
$query = "SELECT r.*, 
          ...
          WHERE r.lActivo = 1 AND r.estado = 'por_entregar'
...
<head>
    ...
    <title>Finalizar Entregas</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1>Finalizar Entregas</h1>
            <p>Confirma la entrega del material solicitado</p>
        </div>
        ...
        <div class="table-container">
            <?php if (empty($requisiciones)): ?>
                <div class="empty">
                    ...
                    <p>No hay cotizaciones por entregar</p>
                </div>
            <?php else: ?>
                <table>
                    <thead>
    ...
    <div class="modal-overlay" id="modalConfirmacion">
        <div class="modal">
            <h2><i class="bi bi-check-circle-fill"></i> Confirmar Entrega</h2>
            <p>¿Confirmas que la requisición <strong id="folioReq"></strong> ha sido entregada al solicitante?</p>
            <div class="modal-actions">
                <button type="button" class="btn btn-cancel" onclick="cerrarModal()">Cancelar</button>
                <button type="button" class="btn btn-success" onclick="confirmarEntrega()">Confirmar</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function confirmarEntrega() {
            ...
            fetch('/ProyectoPHP/frontend/services/marcar_entregado_ajax.php', {
                method: 'POST',
                body: formData
            })
            .then(response => {
